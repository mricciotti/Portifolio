...
export default function Home() {
  useEffect(() => {
    ...
    const setup = () => {
      ...
      items.forEach((item) => {
        ...
        if (!preference.matches && item.getBoundingClientRect().top > window.innerHeight) {
  ...
  return <main id="conteudo" tabIndex={-1}><Hero /><Sobre /><Experiencia /><ProjectList /><SkillList /><Contato /></main>
}
